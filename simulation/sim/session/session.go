...
//
// A session drives a sim.Engine in a loop, applying commands between
...
// everything paradigm-specific is behind sim.Engine.
//
...
import (
	...
	"github.com/hovsep/fmesh-examples/simulation/sim/schedule"
...
func New(engine sim.Engine, opts ...Option) *Session {
